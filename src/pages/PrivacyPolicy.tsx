        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              Currency Circle ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our peer-to-peer currency exchange platform.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-2">2.2 Transaction Information</h3>
                <p className="text-gray-300 leading-relaxed">
                  We collect details about the currency exchanges you make, including amounts, currencies, exchange rates, and transaction dates.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-semibold text-white mb-2">2.3 Device and Usage Information</h3>
                <p className="text-gray-300 leading-relaxed">
                  We automatically collect information about your device, IP address, browser type, operating system, and how you interact with our platform.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1 ml-4">
              ...
              <li>Process and facilitate currency exchanges</li>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">4. Information Sharing</h2>
            <p className="text-gray-300 leading-relaxed mb-2">
              We do not sell your personal information. We may share your information with:
            </p>
            <ul className="list-disc list-inside text-gray-300 space-y-1 ml-4">
              <li>Other users (limited profile information for trades)</li>
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">6. Your Rights</h2>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed">
              We retain your information for as long as your account is active and for a period afterward as required by law (typically 5-7 years for financial records). You may request deletion of your account at any time.
            </p>
          </section>

          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">8. International Transfers</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">9. Cookies and Tracking</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">10. Children's Privacy</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">11. Changes to This Policy</h2>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">12. Contact Us</h2>
            <p className="text-gray-300 leading-relaxed">
              If you have questions about this Privacy Policy or our data practices, please contact us at:
            </p>
            <div className="mt-4 text-gray-300">
              <p>Email: privacy@currencycircle.com</p>
              <p>Address: Currency Circle Ltd., Privacy Department</p>
            </div>
          </section>
        </div>
      </div>
