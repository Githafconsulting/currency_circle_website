...
const CreateOffersSection = () => {
  ...
  return (
    <section id="create-offers" className="relative py-12 sm:py-16 lg:py-32 bg-black overflow-hidden">
      {/* Rounded separator */}
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-8">
          ...
          <div className="flex justify-center lg:justify-end animate-slide-from-center-left w-full lg:w-auto">
            <div className="relative w-full max-w-[280px] sm:max-w-xs lg:max-w-sm">
              {/* Glow effect behind phone */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/30 to-purple-500/30 rounded-full blur-3xl scale-75" />

              {/* Phone mockup with animation */}
              <div className="relative transform hover:scale-105 transition-transform duration-500">
                <img
                  src="/create-offer-new.png"
                  alt="Create Offer Screen"
          ...
          <div className="hidden lg:block relative h-96 mx-4">
            <div className="absolute inset-0 w-px bg-gradient-to-b from-transparent via-primary to-transparent opacity-80"></div>
            <div className="absolute inset-0 w-px bg-gradient-to-b from-transparent via-purple-500 to-transparent opacity-50 blur-sm"></div>
          </div>
          ...
          <div className="max-w-xl space-y-4 sm:space-y-6 animate-slide-from-center-right text-center lg:text-left">
            <div className="inline-block">
              <span className="bg-primary/20 text-white px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-semibold border border-primary/30">
                {t('createOffers.badge')}
              </span>
            </div>

            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight">
              {t('createOffers.title')}
              <span className="block text-gradient mt-2">{t('createOffers.titleGradient')}</span>
            </h2>

            <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
              {t('createOffers.description')}
            </p>
          </div>
        </div>
      </div>
...
export default CreateOffersSection
