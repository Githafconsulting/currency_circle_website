...
const MatchedOffersSection = () => {
  const { t } = useTranslation()
  return (
    <section id="in-discussion" className="relative py-12 sm:py-16 lg:py-32 bg-black overflow-hidden">
      {/* Rounded separator */}
          ...
          <div className="flex justify-center lg:justify-end animate-slide-from-center-left">
            <div className="relative">
              ...
              <div className="relative transform hover:scale-105 transition-transform duration-500">
                <img
                  src="/matched-offers.png"
                  alt="Matched Offers Screen"
          ...
          <div className="max-w-xl space-y-4 sm:space-y-6 animate-slide-from-center-right text-center lg:text-left">
            <div className="inline-block">
              <span className="bg-primary/20 text-white px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-semibold border border-primary/30">
                {t('matchedOffers.badge')}
              </span>
            </div>

            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white leading-tight">
              {t('matchedOffers.title')}
              <span className="block text-gradient mt-2">{t('matchedOffers.titleGradient')}</span>
            </h2>

            <p className="text-base sm:text-lg text-gray-300 leading-relaxed">
              {t('matchedOffers.description')}
            </p>
          </div>
        </div>
      </div>
...
export default MatchedOffersSection
